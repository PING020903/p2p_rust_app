...
use crate::p2p_app::chat::payloads::{
    ChatTextPayload, GroupInvitePayload, GroupLeavePayload, GroupOwnerTransferPayload,
    TAG_CHAT_TEXT, TAG_GROUP_INVITE, TAG_GROUP_LEAVE, TAG_GROUP_MEMBER_LIST,
    TAG_GROUP_OWNER_TRANSFER,
};
use crate::p2p_app::chat::ctx::{
    consume_ops, make_chat_ctx, peer_name, push_cmd, AsyncOp, ChatCtx, Conversation,
};
...
// ctx/control/sidebar/handlers 见 p2p_app/chat/ 同名模块（步2 迁出）。
